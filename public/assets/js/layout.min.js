...
//左侧导航菜单高亮
var url = (window.location.origin + "/" + window.location.pathname.split("/", 2)[1]).replace(/\/$/,"");
var menu = $('ul.page-sidebar-menu > li').find('a[href="'+url+'"]');
var level1 = menu.closest('li').parents('li');
var level2 = menu.closest('li');
level1.addClass('active open');//ul
level2.addClass('active open');//li
level1.children().first().find('.arrow').addClass('open');
level1.children().first().find('.title').after('<span class="selected"></span>');
level2.children().first().find('.title').after('<span class="selected"></span>');